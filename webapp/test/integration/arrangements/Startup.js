sap.ui.define([
	"sap/ui/test/Opa5",
	"it/sidigroup/manageproducts/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("it.sidigroup.manageproducts.ManageProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "it.sidigroup.manageproducts.ManageProducts",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ProductSet/" + sObjectId;
